...
[2 of 2] Compiling Eval1            ( Eval1.hs, Eval1.o )
...
Eval1.runEval1 =
  \ (@ void_alE)
    (m_alb :: Eval1.Eval void_alE)
    (eta_B1 :: State# RealWorld) ->
    case newMutVar#
           @ Int @ RealWorld Eval1.runEval2 eta_B1
    of _ { (# s2#_anm, var#_ann #) ->
    let {
      a_snO :: STRef RealWorld Int

      a_snO =
        STRef @ RealWorld @ Int var#_ann } in
    case (((((m_alb `cast` ...) (a_snO `cast` ...)) `cast` ...)
             (a_snO `cast` ...))
          `cast` ...)
           s2#_anm
    of _ { (# new_s_Xoc, _ #) ->
    readMutVar#
      @ RealWorld @ Int var#_ann new_s_Xoc
    }
    }

Eval1.runEval
  :: forall void_ala.
     Eval1.Eval void_ala -> IO Int
[GblId,
 Arity=2,
 ...
 Unf=Unf{Src=<vanilla>, TopLvl=True, Arity=0, Value=True,
         ConLike=True, Cheap=True, Expandable=True,
         Guidance=ALWAYS_IF(unsat_ok=True,boring_ok=True)}]
Eval1.runEval = Eval1.runEval1 `cast` ...

Eval1.ask3
  :: Eval1.Value
     -> IORef Int
     -> State# RealWorld
     -> (# State# RealWorld, Eval1.Value #)
[GblId,
 Arity=3,
 ...
 Unf=Unf{Src=InlineStable, TopLvl=True, Arity=3, Value=True,
         ConLike=True, Cheap=True, Expandable=True,
         Guidance=ALWAYS_IF(unsat_ok=True,boring_ok=True)
         Tmpl= \ (r_aay [Occ=Once] :: Eval1.Value)
                 _
                 (s_ao4 [Occ=Once] :: State# RealWorld) ->
                 (# s_ao4, r_aay #)}]
Eval1.ask3 =
  \ (r_aay :: Eval1.Value)
    _
    (s_ao4 :: State# RealWorld) ->
    (# s_ao4, r_aay #)
...
[GblId,
 ...
 Unf=Unf{Src=InlineStable, TopLvl=True, Arity=0, Value=True,
         ConLike=True, Cheap=True, Expandable=True,
         Guidance=ALWAYS_IF(unsat_ok=True,boring_ok=True)
         Tmpl= Eval1.ask3 `cast` ...}]
Eval1.ask1 = Eval1.ask3 `cast` ...
...
[GblId,
 ...
 Unf=Unf{Src=InlineStable, TopLvl=True, Arity=0, Value=True,
         ConLike=True, Cheap=True, Expandable=True,
         Guidance=ALWAYS_IF(unsat_ok=True,boring_ok=True)
         Tmpl= Eval1.ask4 `cast` ...}]
Eval1.ask2 = Eval1.ask4 `cast` ...

==================== Asm code ====================
.data
	.align 8
.align 1
.globl __stginit_Eval1
.type __stginit_Eval1, @object
__stginit_Eval1:
.data
	.align 8
.align 1
.globl Eval1_runEval2_closure
.type Eval1_runEval2_closure, @object
Eval1_runEval2_closure:
	.quad	ghczmprim_GHCziTypes_Izh_static_info
	.quad	0
.data
	.align 8
.align 1
.globl Eval1_runEval1_closure
.type Eval1_runEval1_closure, @object
Eval1_runEval1_closure:
	.quad	Eval1_runEval1_info
.text
	.align 8
	.quad	1
	.quad	32
...
.Lcp9:
	movq $254,64(%r13)
	jmp stg_gc_ut
	.size soI_info, .-soI_info
.text
	.align 8
	.quad	8589934597
	.quad	0
	.quad	15
.globl Eval1_runEval1_info
.type Eval1_runEval1_info, @object
Eval1_runEval1_info:
.Lcpi:
	leaq -16(%rbp),%rax
	cmpq %r15,%rax
	jb .Lcpk
	movq %r14,-8(%rbp)
	movl $Eval1_runEval2_closure+1,%ebx
	movq $soI_info,-16(%rbp)
	addq $-16,%rbp
	jmp stg_newMutVarzh
.Lcpk:
	movl $Eval1_runEval1_closure,%ebx
	jmp *-8(%r13)
	.size Eval1_runEval1_info, .-Eval1_runEval1_info
.data
	.align 8
.align 1
.globl Eval1_runEval_closure
.type Eval1_runEval_closure, @object
Eval1_runEval_closure:
	.quad	Eval1_runEval_info
.text
	.align 8
	.quad	8589934597
	.quad	0
	.quad	15
.globl Eval1_runEval_info
.type Eval1_runEval_info, @object
Eval1_runEval_info:
.Lcpt:
	jmp Eval1_runEval1_info
	.size Eval1_runEval_info, .-Eval1_runEval_info
.data
	.align 8
.align 1
.globl Eval1_ask3_closure
.type Eval1_ask3_closure, @object
Eval1_ask3_closure:
	.quad	Eval1_ask3_info
.text
	.align 8
	.quad	12884901900
	.quad	0
	.quad	15
.globl Eval1_ask3_info
.type Eval1_ask3_info, @object
Eval1_ask3_info:
.LcpB:
	movq %r14,%rbx
	jmp *0(%rbp)
	.size Eval1_ask3_info, .-Eval1_ask3_info
.data
	.align 8
.align 1
.globl Eval1_ask1_closure
.type Eval1_ask1_closure, @object
Eval1_ask1_closure:
	.quad	Eval1_ask1_info
.text
	.align 8
	.quad	12884901900
	.quad	0
	.quad	15
.globl Eval1_ask1_info
.type Eval1_ask1_info, @object
Eval1_ask1_info:
.LcpJ:
	jmp Eval1_ask3_info
	.size Eval1_ask1_info, .-Eval1_ask1_info
.data
	.align 8
.align 1
.globl Eval1_ask4_closure
.type Eval1_ask4_closure, @object
Eval1_ask4_closure:
	.quad	Eval1_ask4_info
.text
	.align 8
	.quad	12884901900
	.quad	0
	.quad	15
.globl Eval1_ask4_info
.type Eval1_ask4_info, @object
Eval1_ask4_info:
.LcpR:
	movq %rsi,%rbx
	jmp *0(%rbp)
	.size Eval1_ask4_info, .-Eval1_ask4_info
.data
	.align 8
.align 1
.globl Eval1_ask2_closure
.type Eval1_ask2_closure, @object
Eval1_ask2_closure:
	.quad	Eval1_ask2_info
.text
	.align 8
	.quad	12884901900
	.quad	0
	.quad	15
.globl Eval1_ask2_info
.type Eval1_ask2_info, @object
Eval1_ask2_info:
.LcpZ:
	jmp Eval1_ask4_info
	.size Eval1_ask2_info, .-Eval1_ask2_info
