...
a2_rSk :: GHC.Types.Int
[GblId, Caf=NoCafRefs, Str=DmdType m]
a2_rSk = GHC.Types.I# 2
...
a4_rSm :: [OptimizeMonadTrans.Tree]
...
a5_rSn :: [OptimizeMonadTrans.Tree]
[GblId, Caf=NoCafRefs, Str=DmdType]
a5_rSn =
  GHC.Types.:
    @ OptimizeMonadTrans.Tree OptimizeMonadTrans.Leaf a4_rSm

a6_rSo :: OptimizeMonadTrans.Tree
[GblId, Caf=NoCafRefs, Str=DmdType]
a6_rSo =
...
a7_rSp :: [OptimizeMonadTrans.Tree]
[GblId, Caf=NoCafRefs, Str=DmdType]
a7_rSp = GHC.Types.: @ OptimizeMonadTrans.Tree a6_rSo a4_rSm

tree_rq2 :: OptimizeMonadTrans.Tree
[GblId, Caf=NoCafRefs, Str=DmdType]
tree_rq2 =
  OptimizeMonadTrans.Branch
    (a1_rSj
...
a8_rSq =
  \ (ds_dzd :: [OptimizeMonadTrans.Tree])
    (eta_B3 :: Eval3.Value)
    (eta1_B2 :: Eval3.Value)
    (eta2_B1 :: GHC.Prim.State# GHC.Prim.RealWorld) ->
    case ds_dzd of _ {
      ...
      : x_aty xs_atz ->
        case x_aty of _ {
          OptimizeMonadTrans.Branch action_atB children_atC ->
            case (((action_atB
            ...
            case ipv1_ajz of _ { GHC.Types.I# x1_aAI ->
            case ipv3_Xkv of _ { GHC.Types.I# y_aAM ->
            case GHC.Prim.writeMutVar#
                   @ GHC.Prim.RealWorld
                   @ GHC.Types.Int
                   var#_ak1
                   (GHC.Types.I# (GHC.Prim.+# x1_aAI y_aAM))
                   ipv2_Xkt
            of s2#_aC7 { __DEFAULT ->
            a8_rSq
              (GHC.Base.++ @ OptimizeMonadTrans.Tree children_atC xs_atz)
              (wild2_ajZ
               `cast` (Sym <(GHC.IORef.NTCo:IORef)> <GHC.Types.Int>
                       :: GHC.STRef.STRef GHC.Prim.RealWorld GHC.Types.Int
                            ~#
          ...
          OptimizeMonadTrans.Leaf ->
            ...
            case ipv1_Xk3 of _ { GHC.Types.I# x1_aAI ->
            case GHC.Prim.writeMutVar#
                   @ GHC.Prim.RealWorld
                   @ GHC.Types.Int
                   var#_ak1
                   (GHC.Types.I# (GHC.Prim.+# x1_aAI 1))
                   ipv_Xk1
            of s2#_aC7 { __DEFAULT ->
            a8_rSq
              xs_atz
...
a9_rSr :: [OptimizeMonadTrans.Tree]
[GblId, Caf=NoCafRefs, Str=DmdType]
a9_rSr =
  GHC.Types.:
    @ OptimizeMonadTrans.Tree
